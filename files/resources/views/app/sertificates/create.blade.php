...
@section('content')
    ...
    <h1 class="text-uppercase mt-5">sertificates</h1>

    <div class="headcrumbs d-flex mb-3">
        <a href="{{ route('sertificates.index') }}" class="d-flex text-uppercase me-2" style="opacity:25%">sertificates</a> >> <a class="d-flex text-uppercase ms-2">create</a>
    </div>
