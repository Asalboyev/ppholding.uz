...
{{--                    <a href="#" class="header__lang-item header__lang-item--active">Ру</a>--}}
                ...
                <div class="header__contact">
                    ...
                    <a href="tel:+998999999999" class="header__contact-link">{{ translation('phone_number') }}</a>
                </div>
            </nav>
        </div>
    </div>
...
{{--                        </li>--}}
            ...
            <div class="footer__contacts">
                <div class="footer__contacts-item">
                    ...
                    <a href="tel:+998999999999" class="footer__contacts-item-link ir-bold">{{ translation('phone_number') }}</a>
                </div>
                <div class="footer__contacts-item">
