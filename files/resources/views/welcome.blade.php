...
{{--                    </div>--}}
            ...
            <div class="container">
                <div class="about-product__inner">
                    <div class="about-product__img">
                        <img src="{{ asset('images/about-product.png') }}" alt="">
                    </div>
        ...
        <section class="partners">
            ...
            <div class="partners__slider">
                <div class="partners__slider-track">
                    @foreach($partners as $partner)
                    <div class="partners__slide">
                        <img src="{{ asset($partner->img) }}" height="100" width="250" alt="" />
                    </div>
                    @endforeach
{{--                    <div class="partners__slide">--}}
{{--                        <img src="images/partner-2.png" height="100" width="250" alt="" />--}}
{{--                    </div>--}}
{{--                    <div class="partners__slide">--}}
{{--                        <img src="images/partner-3.png" height="100" width="250" alt="" />--}}
{{--                    </div>--}}
{{--                    <div class="partners__slide">--}}
{{--                        <img src="images/partner-4.png" height="100" width="250" alt="" />--}}
{{--                    </div>--}}
{{--                    <div class="partners__slide">--}}
{{--                        <img src="images/partner-5.png" height="100" width="250" alt="" />--}}
{{--                    </div>--}}
{{--                    <div class="partners__slide">--}}
{{--                        <img src="images/partner-1.png" height="100" width="250" alt="" />--}}
{{--                    </div>--}}
{{--                    <div class="partners__slide">--}}
{{--                        <img src="images/partner-2.png" height="100" width="250" alt="" />--}}
{{--                    </div>--}}
