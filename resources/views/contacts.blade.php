                ...
                <div class="items">
                    <div class="item">
                        ...
                        <div class="item__info">
                            ...
                            <a href="tel:{!! translation('phone_number') !!}" class="item__link ro-medium">{!! translation('phone_number') !!}</a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="item__icon">
            ...
            <div class="contacts-inner">
                <div class="contacts-form">
                    ...
                    <form action="{{ route('application') }}" method="post">
                        ...
                        <input id="mask" type="text" class="contacts-form__input ro-regular" required name="phone_number" placeholder="{{ translation('phone_number_txt') }}">
